        ...
        <div class="forms">
            <div class="form-content">
                <div class="login-form">
                    ...
                    <div style="margin-top:15px;margin-bottom:-20px;" class="alert alert-success" role="alert">
                        {{ Session::get('success') }}
                    </div>
                    @endif
                    <form action="{{ route('register') }}" method="POST">
                        <div class="input-boxes">
                            @csrf
                            <div class="input-box">
                                <i style="padding-left:7px;color:#fdad00;" class="fas fa-user"></i>
                            ...
                            <div class="d-grid">
                                ...
                                <button style="background-color:#fdad00;border-color:white;" class="btn ">Register</button>

                            </div>
                            <div class="text sign-up-text">Already have an account? <a style="text-decoration:none;" href="login">Login now</label>
                            </div>
                        </div>
                    </form>
                </div>
